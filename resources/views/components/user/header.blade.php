        ...
        <div class="container">
            <div class="utf_left_side">
                <div id="logo"><a href="index_1.html"><img src="{{asset('assets/web/images/logo.png')}}" alt=""></a>
                    <a href="index_1.html" class="dashboard-logo">
                ...
                <div class="header_widget">
                    ...
                    <div class="utf_user_menu">
                        <div class="utf_user_name"><span><img
                                    ...
                                    alt=""></span>{{\Illuminate\Support\Facades\Auth::user()->firstname}}
                        </div>
                        <ul>
                            <li><a href="{{route('user.dashboard')}}"><i class="sl sl-icon-layers"></i> Dashboard</a>
                            </li>
                            <li><a href="{{route('user.profile')}}"><i class="sl sl-icon-user"></i> My Profile</a></li>
                            <li><a href="{{route('user.my-ads')}}"><i class="sl sl-icon-list"></i> My Ads</a></li>
                            <li><a onclick="event.preventDefault(); document.getElementById('submit-form').submit();" href="{{route('logout')}}"><i class="sl sl-icon-power"></i> Logout</a></li>
