            ...
            <div class="utf_right_side">
                <div class="header_widget">
                    ...
                    <div class="utf_user_menu">
                        <div class="utf_user_name"><span><img src="{{asset('assets/web/images/dashboard-avatar.jpg')}}" alt=""></span>Hi, John!
                        </div>
                        <ul>
                            ...
                            <li><a href="dashboard_messages.html"><i class="sl sl-icon-envelope-open"></i> Messages</a>
                            </li>
