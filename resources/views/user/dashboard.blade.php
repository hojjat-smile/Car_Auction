                    ...
                    <div class="utf_dashboard_list_box table-responsive recent_booking">
                        ...
                        <div class="dashboard-list-box table-responsive invoices with-icons">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('assets/web/images/thumb-1.jpg')}}" width="50" height="50"></td>
                                    <td>Kathy Brown</td>
                                    <td>12 Jan 2019</td>
                                    <td>Paypal</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('assets/web/images/thumb-2.jpg')}}" width="50" height="50"></td>
                                    <td>Kathy Brown</td>
                                    <td>12 Jan 2019</td>
                                    <td>Credit Card</td>
                                    <td><span class="badge badge-pill badge-primary text-uppercase">Booked</span></td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('assets/web/images/thumb-3.jpg')}}" width="50" height="50"></td>
                                    <td>Kathy Brown</td>
                                    <td>12 Jan 2019</td>
                                    <td>Paypal</td>
